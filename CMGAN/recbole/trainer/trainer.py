...
class KGATTrainer(Trainer):
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        ...
        # return rs_total_loss, 0.1 * kg_total_loss
        # return rs_total_loss, 0.01 * kg_total_loss
        # return rs_total_loss, 0.001 * kg_total_loss
        # return rs_total_loss, 0.0001kg_total_loss
